// Removed JSMSoln and my name to display string
// created new entry for Wire1 I2C driver - see setup() in .ino file
...
extern void ResetSignalRefreshTimer();
   ...
   SSD1306AsciiWire display(Wire1);
...
//Serial.print(F("set up OLED \n"));

   #define SCREEN_WIDTH 128 // OLED display width, in pixels
   #define SCREEN_HEIGHT 64 // OLED display height, in pixels

//   Serial.print(F("call display setup\n"));
   Adafruit_SSD1306 display(SCREEN_WIDTH, SCREEN_HEIGHT,  &Wire1, -1);
//   Serial.print(F("after OLED call \n")); 
